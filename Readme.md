...
# Configuration Script – 0001-01 - Rev. B

This **Configuration** script is designed for the **0001-01** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – 0001-01 Rev. B

Este script de **Configuration** está diseñado para el modelo **0001-01** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
